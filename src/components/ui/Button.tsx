...
const VARIANT_CLASS: Record<Variant, string> = {
  primary:
    "bg-accent text-accent-foreground hover:bg-accent-hover border border-accent disabled:bg-surface-3 disabled:text-text-disabled disabled:border-border-default",
  secondary:
